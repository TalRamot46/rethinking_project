...
%==============================================================================
\section{Introduction - The Problem: Ratings are biased by the number of reviews}
%==============================================================================
...
%==============================================================================
\section{A cool analogy to the Reed frog model}
%==============================================================================
...
in \texttt{src/03-models.R} in the attached code.
...
\todo{One warning about the fixed prior. Ratings here sit near $4.79$, which means
...
Complete pooling, \texttt{m13.0}, is the other extreme: a single intercept
shared by every listing, which says the listings do not differ at all and every
gap between them is sampling noise. Its pWAIC of $2.8$ is the smallest in the
table, and it is the \emph{only} model whose effective parameter count is close
...
both. That ordering is what the whole chapter is about, and Appendix A tests it
where the truth is actually known rather than inferred from WAIC.
...
\textbf{A purely predictive criterion, which knows nothing about priors, and a purely
...
%==============================================================================
\appendix
\section{Simulation Study: Evaluating Estimation Error Against Known Truth}
%==============================================================================

In real observational data, the true underlying probability $p_i^{\text{true}}$ for each listing is unobservable; we observe only the noisy sample outcome $P_i \sim \text{Binomial}(N_i, p_i)$. To evaluate how accurately complete pooling, no pooling, and partial pooling recover the true underlying probabilities, we conduct a controlled simulation study following Section 13.2 of \emph{Statistical Rethinking} (R code 13.9--13.20).
...
\subsection{Key Findings from the Simulation}
