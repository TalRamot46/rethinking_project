...
single proposal can traverse the typical set rather than jitter within it (see Lecture 9 of McElreath's Statistical Rethinking playlist, \href{https://www.youtube.com/watch?v=Qqz5AJjyugM\&list=PLDcUM9US4XdMROZ57-OIRtIK0aOynbgZN\&index=9}{video link}~\cite{mcelreath2023_lecture09}).
...
\end{align*}
\paragraph{Fun Fact.} I use the Leapfrog integration method myself \underline{in my thesis}, which involves simulations of thermal radiation transfer coupled with hydrodynamic equations, in which conservation of total energy using a symplectic scheme is essential for simulating complex multi-physics schemes.
